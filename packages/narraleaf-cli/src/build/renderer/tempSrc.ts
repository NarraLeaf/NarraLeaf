import RendererEntryTemplateApp from "@/build/assets/renderer-entry-template-app.ejs";
import RendererEntryTemplateHTML from "@/build/assets/renderer-entry-template-html.ejs";
import { BuildTempStructure as Structure, StructureEntityType } from "@/build/renderer/prepare";
import { createAppRouter, LayoutDir, PageData } from "@/build/renderer/router/scan";
import { Project } from "@/project/project";
import { RendererProject } from "@/project/renderer/rendererProject";
import { safeImportPath } from "@/utils/string";
import { AppHost, AppProtocol, RendererOutputFileName } from "@narraleaf/shared";
import ejs from "ejs";
